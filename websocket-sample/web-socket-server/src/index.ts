...
// So whenevr there is a connection, control reaches the connection function and you get a ws instance
wss.on("connection", function connection(ws) {
    ...
    ws.on("message", function message(data, isBinary) {
        // for every client, check if connection is open to them and then send them data
